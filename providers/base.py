...
class BaseLLMProvider(ABC):
    ...
    def parse_error(self, status_code: int, response_data: Dict[str, Any]) -> LLMError:
        ...
        return LLMError(
            error_type=error_type, message=error_msg, status_code=status_code, provider=self.name
        )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.chat(messages=test_messages, max_tokens=10, timeout=10)
