...
class OpenAICompatProvider(BaseLLMProvider):
        ...
        try:
            ...
            async with aiohttp.ClientSession(
                ...
                async with session.post(
                    f"{self.base_url}/chat/completions", headers=self.get_headers(), json=payload
                ) as response:
                ...
                async with session.post(
                    ...
                    async for line in response.content:
                        ...
                        try:
                            ...
                            yield {"provider": self.name, "model": model, "data": data}
    ...
    def parse_error(self, status_code: int, response_data: Dict[str, Any]) -> LLMError:
        ...
        if (
            ...
            error_type_str == "rate_limit_exceeded"
