...
NINE_TABLES_ALIASES = [
    TableAlias(
        ...
        regex_patterns=[r"收入.*支出.*决算.*总表", r"收支.*决算.*总表", r"收入.*支出.*总表"],
        category="总表",
        required=True,
    ),
    TableAlias(
        standard_name="收入决算表",
        aliases=["收入决算表", "收入表", "决算收入表", "财政收入决算表", "收入决算明细表"],
        regex_patterns=[r"收入.*决算表?", r"决算.*收入表?"],
        category="收入",
        required=True,
    ),
    TableAlias(
        standard_name="支出决算表",
        aliases=["支出决算表", "支出表", "决算支出表", "财政支出决算表", "支出决算明细表"],
        regex_patterns=[r"支出.*决算表?", r"决算.*支出表?"],
        category="支出",
        required=True,
    ),
    TableAlias(
...
class TableAliasMatcher:
    ...
    def find_tables_in_document(self, pages_text: List[str]) -> Dict[str, List[Dict[str, Any]]]:
        ...
        """
        found_tables: Dict[str, List[Dict[str, Any]]] = {}
